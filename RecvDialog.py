...
################################################################################
## Form generated from reading UI file 'RecvDialog.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.IPLabel = QLabel(self.TopFrameLeftr)
        ...
        self.IPEditLabel = QLabel(self.TopFrameRight)
        self.IPEditLabel.setObjectName(u"IPEditLabel")
        self.IPEditLabel.setFont(font1)

        self.verticalLayout_3.addWidget(self.IPEditLabel)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.IPLabel.setText(QCoreApplication.translate("Dialog", u"IP:", None))
        self.FileNameEditLabel.setText(QCoreApplication.translate("Dialog", u"FileName", None))
        self.IPEditLabel.setText(QCoreApplication.translate("Dialog", u"IP Info Placeholder", None))
